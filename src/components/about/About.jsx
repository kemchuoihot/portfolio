      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            Motivated and dynamic aspiring front-end developer seeking an
            position to leverage my enthusiasm for learning, creativity, and
            dedication. Eager to contribute to a team environment and further
            develop my skills in web technologies.
          </p>
