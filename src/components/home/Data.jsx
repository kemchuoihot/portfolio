        ...
        <div className="home__data" data-aos="zoom-in-up">
            <h1 className="home__title">
                ...
                <svg
                    ...
                    viewBox="0 0 48 48"
                    fill="none"
                    xmlns="http://www.w3.org/var(--container-color)/svg"
                    class="home__hand"
                    >
                    <path
            ...
            <h3 className="home__subtitle">Front-end Development</h3>
            <p className="home__description">I'm a final-year Software Engineering student. I love to work as a front-end</p>
